...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_the_desired_location(self):
        llogin = self.client.login(
            username='testuser1', password='1X<ISRUkw+tuK'
        )
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_logged_in_users_correct_template(self):
        ...
        #Check that we got a "success" repsonse
        self.assertEqual(response.status_code, 200)
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        test_user2.save()
        test_user2 = User.objects.get(
            username='testuser2'
        )
        # print(test_user2.get_all_permissions())
        # Create a book
        test_author = Author.objects.create(
            first_name = 'John',
            last_name = 'Smith'
        ...
        self.test_bookinstance1 = BookInstance.objects.create(
            book = test_book,
            imprint = 'Unlikely Implrint, 2006',
            due_back = return_date,
            borrower = test_user1,
            status = 'o',
        )
